...
int main() {
    ...
    CatatanAkademik catatan("Reyvaldi", "202211019");

    // Menambahkan mata kuliah
    catatan.tambahMataKuliah("OOP", 85);
    catatan.tambahMataKuliah("AI", 90);

    // Menampilkan catatan akademik
    catatan.tampilkanCatatanAkademik();

    // Menambahkan mata kuliah baru
    catatan.tambahMataKuliah("Basis Data", 87);

    // Menampilkan catatan akademik setelah perubahan
    catatan.tampilkanCatatanAkademik();

    // Menghapus mata kuliah
    catatan.hapusMataKuliah("OOP");
